...
export const listings = [
  { id: 1, type: "apartment", name: "The Lofts at GSU",   address: "75 Piedmont Ave NE",  rating: 4.3, reviewCount: 12, verified: true, rentMin: 1150, rentMax: 1400, distanceMi: 0.4, beds: 1 },
  { id: 2, type: "apartment", name: "Auburn Ave Flats",   address: "210 Auburn Ave NE",   rating: 4.6, reviewCount: 8,  verified: true, rentMin: 1300, rentMax: 1650, distanceMi: 0.6, beds: 2 },
  { id: 3, type: "apartment", name: "Edgewood Court",     address: "130 Edgewood Ave SE", rating: 4.0, reviewCount: 15, verified: true, rentMin: 1050, rentMax: 1300, distanceMi: 0.5, beds: 1 },
